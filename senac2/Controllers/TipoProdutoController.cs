...
namespace senac2.Controllers
{
    public class TipoProdutoController : Controller
    {
        ...
        public TipoProdutoController(DataBaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Nome,Id,CreatedDate,UpdatedData")] TipoProduto tipoProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,Id,CreatedDate,UpdatedData")] TipoProduto tipoProduto)
        {
